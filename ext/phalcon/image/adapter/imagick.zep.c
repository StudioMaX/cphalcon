...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, __construct)
{
	...
	if ((zephir_file_exists(&_2) == SUCCESS)) {
		...
		ZEPHIR_CALL_FUNCTION(&_4$$4, "realpath", NULL, 92, &_3$$4);
		zephir_check_call_status();
		...
		if (UNEXPECTED(!zephir_is_true(&_6$$4))) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_8$$5, "phalcon/Image/Adapter/Imagick.zep", 58);
			ZEPHIR_MM_RESTORE();
			return;
		}
		...
		if (!(zephir_is_true(&_12$$4))) {
			...
			ZEPHIR_CALL_FUNCTION(&_15$$6, "constant", NULL, 127, &_14$$6);
			zephir_check_call_status();
		...
		if (UNEXPECTED(_20$$8)) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_21$$9, "phalcon/Image/Adapter/Imagick.zep", 79);
			ZEPHIR_MM_RESTORE();
			return;
		}
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, check)
{
	...
	if (UNEXPECTED(!(zephir_class_exists(&_1, 1)))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_image_exception_ce, "Imagick is not installed, or the extension is not loaded", "phalcon/Image/Adapter/Imagick.zep", 123);
		return;
	}
	ZEPHIR_INIT_VAR(&_2);
	ZVAL_STRING(&_2, "Imagick::IMAGICK_EXTNUM");
	ZEPHIR_CALL_FUNCTION(&_3, "defined", NULL, 126, &_2);
	zephir_check_call_status();
	if (zephir_is_true(&_3)) {
		ZEPHIR_INIT_VAR(&_4$$5);
		ZVAL_STRING(&_4$$5, "Imagick::IMAGICK_EXTNUM");
		ZEPHIR_CALL_FUNCTION(&_5$$5, "constant", NULL, 127, &_4$$5);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processBackground)
{
	...
	ZVAL_LONG(&_2, g);
	ZVAL_LONG(&_3, b);
	ZEPHIR_CALL_FUNCTION(&color, "sprintf", NULL, 193, &_0, &_1, &_2, &_3);
	zephir_check_call_status();
	...
	while (1) {
		...
		if (!(zephir_is_true(&_7$$3))) {
			...
			ZEPHIR_CALL_FUNCTION(&_10$$4, "constant", &_11, 127, &_9$$4);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_15$$3, "constant", &_11, 127, &_14$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_14$$3);
		ZVAL_STRING(&_14$$3, "Imagick::CHANNEL_ALPHA");
		ZEPHIR_CALL_FUNCTION(&_16$$3, "constant", &_11, 127, &_14$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_22$$3, "constant", &_11, 127, &_14$$3);
		zephir_check_call_status();
		ZVAL_LONG(&_23$$3, 0);
		ZVAL_LONG(&_24$$3, 0);
		...
		if (UNEXPECTED(!ZEPHIR_IS_TRUE_IDENTICAL(&ret))) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_image_exception_ce, "Imagick::compositeImage failed", "phalcon/Image/Adapter/Imagick.zep", 199);
			return;
		}
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processLiquidRescale)
{
	...
	while (1) {
		...
		zephir_check_call_status();
		if (UNEXPECTED(!ZEPHIR_IS_TRUE_IDENTICAL(&ret))) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_image_exception_ce, "Imagick::liquidRescale failed", "phalcon/Image/Adapter/Imagick.zep", 305);
			return;
		}
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processMask)
{
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_6$$3, "constant", &_7, 127, &_5$$3);
		zephir_check_call_status();
		ZVAL_LONG(&_8$$3, 0);
		ZVAL_LONG(&_9$$3, 0);
		...
		zephir_check_call_status();
		if (UNEXPECTED(!ZEPHIR_IS_TRUE_IDENTICAL(&ret))) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_image_exception_ce, "Imagick::compositeImage failed", "phalcon/Image/Adapter/Imagick.zep", 343);
			return;
		}
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processReflection)
{
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_20$$7, "constant", &_21, 127, &_19$$7);
		zephir_check_call_status();
		ZVAL_LONG(&_22$$7, 0);
		ZVAL_LONG(&_23$$7, 0);
		...
		zephir_check_call_status();
		if (UNEXPECTED(!ZEPHIR_IS_TRUE_IDENTICAL(&ret))) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_image_exception_ce, "Imagick::compositeImage failed", "phalcon/Image/Adapter/Imagick.zep", 438);
			return;
		}
		ZEPHIR_INIT_NVAR(&_19$$7);
		ZVAL_STRING(&_19$$7, "Imagick::EVALUATE_MULTIPLY");
		ZEPHIR_CALL_FUNCTION(&_25$$7, "constant", &_21, 127, &_19$$7);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_19$$7);
		ZVAL_STRING(&_19$$7, "Imagick::CHANNEL_ALPHA");
		ZEPHIR_CALL_FUNCTION(&_26$$7, "constant", &_21, 127, &_19$$7);
		zephir_check_call_status();
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_37$$10, "constant", &_21, 127, &_36$$10);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_45$$10, "constant", &_21, 127, &_36$$10);
		zephir_check_call_status();
		ZVAL_LONG(&_46$$10, 0);
		ZVAL_LONG(&_47$$10, 0);
		...
		zephir_check_call_status();
		if (UNEXPECTED(!ZEPHIR_IS_TRUE_IDENTICAL(&ret))) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_image_exception_ce, "Imagick::compositeImage failed", "phalcon/Image/Adapter/Imagick.zep", 483);
			return;
		}
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_51$$13, "constant", &_21, 127, &_50$$13);
		zephir_check_call_status();
		...
		zephir_check_call_status();
		if (UNEXPECTED(!ZEPHIR_IS_TRUE_IDENTICAL(&ret))) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_image_exception_ce, "Imagick::compositeImage failed", "phalcon/Image/Adapter/Imagick.zep", 503);
			return;
		}
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processRender)
{
	...
	if (ZEPHIR_IS_LONG_IDENTICAL(&_5, 0)) {
		...
		if (_8$$4) {
			...
			ZEPHIR_CALL_FUNCTION(&_11$$5, "constant", NULL, 127, &_10$$5);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processSave)
{
	...
	if (ZEPHIR_IS_LONG(&_8, 0)) {
		...
		ZVAL_STRING(&_10$$3, "w");
		ZEPHIR_CALL_FUNCTION(&fp, "fopen", NULL, 87, &file, &_10$$3);
		zephir_check_call_status();
		...
		if (_14$$4) {
			zephir_read_property(&_16$$5, this_ptr, ZEND_STRL("image"), PH_NOISY_CC | PH_READONLY);
			ZEPHIR_INIT_VAR(&_17$$5);
			ZVAL_STRING(&_17$$5, "Imagick::COMPRESSION_JPEG");
			ZEPHIR_CALL_FUNCTION(&_18$$5, "constant", NULL, 127, &_17$$5);
			zephir_check_call_status();
		...
		zephir_read_property(&_21$$4, this_ptr, ZEND_STRL("image"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processText)
{
	...
	if (((Z_TYPE_P(offsetX) == IS_TRUE || Z_TYPE_P(offsetX) == IS_FALSE) == 1)) {
		if (((Z_TYPE_P(offsetY) == IS_TRUE || Z_TYPE_P(offsetY) == IS_FALSE) == 1)) {
			...
			ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 127, &_6$$7);
			zephir_check_call_status();
		} else {
			if (Z_TYPE_P(offsetY) == IS_LONG) {
				...
				if (zephir_is_true(offsetX)) {
					...
					if (y < 0) {
						...
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 127, &_7$$11);
						zephir_check_call_status();
					} else {
						ZVAL_LONG(offsetX, 0);
						ZEPHIR_INIT_VAR(&_8$$12);
						ZVAL_STRING(&_8$$12, "Imagick::GRAVITY_NORTHEAST");
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 127, &_8$$12);
						zephir_check_call_status();
					}
				} else {
					ZEPHIR_INIT_NVAR(offsetX);
					if (y < 0) {
						...
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 127, &_9$$14);
						zephir_check_call_status();
					} else {
						ZVAL_LONG(offsetX, 0);
						ZEPHIR_INIT_VAR(&_10$$15);
						ZVAL_STRING(&_10$$15, "Imagick::GRAVITY_NORTH");
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 127, &_10$$15);
						zephir_check_call_status();
					}
				}
			}
				...
				if (((Z_TYPE_P(offsetY) == IS_TRUE || Z_TYPE_P(offsetY) == IS_FALSE) == 1)) {
					if (zephir_is_true(offsetY)) {
						...
						if (x < 0) {
							...
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 127, &_11$$21);
							zephir_check_call_status();
						} else {
							ZVAL_LONG(offsetY, 0);
							ZEPHIR_INIT_VAR(&_12$$22);
							ZVAL_STRING(&_12$$22, "Imagick::GRAVITY_SOUTH");
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 127, &_12$$22);
							zephir_check_call_status();
						}
					} else {
						ZEPHIR_INIT_NVAR(offsetY);
						if (x < 0) {
							...
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 127, &_13$$24);
							zephir_check_call_status();
						} else {
							ZVAL_LONG(offsetY, 0);
							ZEPHIR_INIT_VAR(&_14$$25);
							ZVAL_STRING(&_14$$25, "Imagick::GRAVITY_WEST");
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 127, &_14$$25);
							zephir_check_call_status();
						}
					}
				} else {
					if (Z_TYPE_P(offsetY) == IS_LONG) {
						...
						if (x < 0) {
							...
							if (y < 0) {
								...
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 127, &_15$$29);
								zephir_check_call_status();
							} else {
								ZVAL_LONG(offsetX, (x * -1));
								ZEPHIR_INIT_VAR(&_16$$30);
								ZVAL_STRING(&_16$$30, "Imagick::GRAVITY_NORTHEAST");
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 127, &_16$$30);
								zephir_check_call_status();
							}
						} else {
							ZEPHIR_INIT_NVAR(offsetX);
							if (y < 0) {
								...
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 127, &_17$$32);
								zephir_check_call_status();
							} else {
								ZVAL_LONG(offsetX, 0);
								ZEPHIR_INIT_VAR(&_18$$33);
								ZVAL_STRING(&_18$$33, "Imagick::GRAVITY_NORTHWEST");
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 127, &_18$$33);
								zephir_check_call_status();
							}
						}
					}
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processWatermark)
{
	...
	ZEPHIR_CALL_FUNCTION(&_2, "constant", NULL, 127, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Imagick::CHANNEL_ALPHA");
	ZEPHIR_CALL_FUNCTION(&_3, "constant", NULL, 127, &_1);
	zephir_check_call_status();
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_8$$3, "constant", NULL, 127, &_7$$3);
		zephir_check_call_status();
		...
		zephir_check_call_status();
		if (UNEXPECTED(!ZEPHIR_IS_TRUE_IDENTICAL(&ret))) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_image_exception_ce, "Imagick::compositeImage failed", "phalcon/Image/Adapter/Imagick.zep", 831);
			return;
		}
		zephir_read_property(&_9$$3, this_ptr, ZEND_STRL("image"), PH_NOISY_CC | PH_READONLY);
